                                    ...
                                    <div class="card-body p-4">
                                        <div class="d-flex justify-content-between align-items-start mb-3">
                                            <div>
                                                ...
                                                <p class="text-muted small mb-0"><i class="fas fa-map-marker-alt me-1"></i>{{ Str::limit($arena->location, 50) }}</p>
                                            </div>
                                        ...
                                        <div class="row g-3 mb-4">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <h6 class="text-primary">{{ number_format($arena->price, 0, ',', '.') }} đ</h6>
                                            </div>
                                        </div>
                ...
                @else
                    <div class="card border-0 rounded-4 shadow-sm bg-white py-5">
                        <div class="text-center px-4">
                            ...
                            <a href="{{ route('owner.arenas.create') }}" class="btn btn-hero-primary btn-lg px-5 py-3">Thêm Sân Ngay</a>
                        </div>
                    </div>
                @endif
            </div>
