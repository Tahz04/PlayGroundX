    ...
    <div class="container">
        <div class="row mb-5 align-items-center">
            <div class="col">
                ...
                <h1 class="display-6 mb-3">Thêm Sân Mới</h1>
                <p class="text-muted">Nhập thông tin chi tiết về sân bóng của bạn.</p>
            </div>
        </div>
                    ...
                    <div class="card-body p-5">
                        ...
                        <form action="{{ route('owner.arenas.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="VD: Sân Bóng ABC" value="{{ old('name') }}">
                                @error('name')
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-md-6">
                                    ...
                                    <select name="type" id="type" class="form-select @error('type') is-invalid @enderror">
                                        ...
                                        <option value="Sân 5" {{ old('type') === 'Sân 5' ? 'selected' : '' }}>Sân 5</option>
                                        <option value="Sân 7" {{ old('type') === 'Sân 7' ? 'selected' : '' }}>Sân 7</option>
                                        <option value="Sân 11" {{ old('type') === 'Sân 11' ? 'selected' : '' }}>Sân 11</option>
                                    </select>
                                    @error('type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="price" id="price" class="form-control @error('price') is-invalid @enderror" placeholder="500000" value="{{ old('price') }}" step="1000">
                                    @error('price')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="location" id="location" class="form-control @error('location') is-invalid @enderror" placeholder="VD: 123 Đường ABC, Quận 1, TP HCM" value="{{ old('location') }}">
                                @error('location')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
